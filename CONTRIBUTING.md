# Contributing to Graviola

If you want to contribute to Graviola, that's awesome. Here you will find a few simple rules to follow.
...
If you're not sure how to open an Issue and submit a _good_ bug report, please check out:
...
~~Graviola repo uses [lint-staged](https://github.com/lint-staged/lint-staged) to automatically format and lint code before committing changes. We're not very restrictive about code style. Commit names can be anything you want, as long as they're respectful and follow github ToS.
